...
os.execute("dir C:\\Tree\\Tree_news\\html_tree*.html /b/o/s > C:\\Tree\\Tree_news\\dir_Tree_news.txt")
dayBefore="00000000"
for line in io.lines("C:\\Tree\\Tree_news\\dir_Tree_news.txt") do
...
end --for line in io.lines("C:\\Tree\\Tree_news\\dir_Tree_news.txt") do

--1.1 read html file from convertion before
beforeText={}
for line in io.lines("C:\\Tree\\Tree_news\\html_tree_" .. dayBefore .. ".html") do
if line:match("<ul><li>.-: .-</li></ul>") then
--print(line:match("<ul><li>.-: (.-)</li></ul>"))
beforeText[line:match("<ul><li>.-: (.-)</li></ul>")]=true
end
end --for line in io.lines("C:\\Tree\\Tree_news\\html_tree_" .. dayBefore .. ".html") do

--2. build new tree with titles
outputfile_news=io.open("C:\\Tree\\Tree_news\\html_tree_" .. os.date("%Y%m%d") .. ".html","w")
inputText={}
dateBranch=""
for line in io.lines("C:\\Tree\\a.txt") do
...
end --for line in io.lines("C:\\Tree\\a.txt") do
