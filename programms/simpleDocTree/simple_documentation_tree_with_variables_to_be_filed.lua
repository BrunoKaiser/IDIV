...
for line in io.lines("C:\\Tree\\simpleDocTree\\simple_documentation_tree_with_variables_to_be_filed.lua") do
	...
	elseif lineRead=="yes" and line:match('"')==nil and line:match('^%-%-')==nil then
...
end --for line in io.lines("C:\\Tree\\simpleDocTree\\simple_documentation_tree_with_variables_to_be_filed.lua") do
