...
button1:addMouseListener(luajava.createProxy("java.awt.event.MouseListener",{
	mousePressed=function(e) 
		...
		if changeText=="yes" then
			...
			outputfile1=io.open("/Tree/Tree_Luajava_output.txt","w")
			outputfile_tree=io.open("/Tree/Tree_Luajava_output_Tree.lua","w")
			...
			--restart the GUI 
			os.execute("java -classpath /Tree/luaj-jse-3.0.1.jar lua /Tree/Tree_Luajava_Linux.lua") 
			os.exit()
...
button2:addMouseListener(luajava.createProxy("java.awt.event.MouseListener",{
	mousePressed=function(e) 
		...
		for line in io.lines("/Tree/Tree_Luajava_output.txt") do
			if line:match(searchText) then
				resultText=resultText .. line .. "\n"
			end --if line:match(searchText) then
		end --for line in io.lines("/Tree/Tree_Luajava_output.txt") do
