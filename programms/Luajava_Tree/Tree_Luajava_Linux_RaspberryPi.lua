--java -classpath /home/pi/Tree/Luajava_Tree/Tree.jar lua /home/pi/Tree/Luajava_Tree/Tree_Luajava_Linux.lua &

--1. take tree from file
dofile("/home/pi/Tree/Luajava_Tree/Tree_Luajava_output_Tree.lua")
...
["Baumprogramme"]=function() ErgebnisText ="" p=io.popen('ls /home/pi/Tree/Luajava_Tree') for line in p:lines() do print(line) if ErgebnisText=="" then ErgebnisText= "/home/pi/Tree/Luajava_Tree/" .. tostring(line) else ErgebnisText= ErgebnisText .. "\n/Tree/" .. tostring(line) end end 
textArea1:setText("p=io.popen('ls /home/pi/Tree/Luajava_Tree')")
...
button1:addMouseListener(luajava.createProxy("java.awt.event.MouseListener",{
	mousePressed=function(e) 
		...
		if changeText=="yes" then
			...
			outputfile1=io.open("/home/pi/Tree/Luajava_Tree/Tree_Luajava_output.txt","w")
			outputfile_tree=io.open("/home/pi/Tree/Luajava_Tree/Tree_Luajava_output_Tree.lua","w")
			...
			--restart the GUI 
			os.execute("java -classpath /home/pi/Tree/Luajava_Tree/Tree.jar lua /home/pi/Luajava_Tree/Tree/Tree_Luajava_Linux.lua &") 
			os.exit()
...
button2:addMouseListener(luajava.createProxy("java.awt.event.MouseListener",{
	mousePressed=function(e) 
		...
		for line in io.lines("/home/pi/Tree/Luajava_Tree/Tree_Luajava_output.txt") do
			if line:match(searchText) then
				resultText=resultText .. line .. "\n"
			end --if line:match(searchText) then
		end --for line in io.lines("/home/pi/Tree/Luajava_Tree/Tree_Luajava_output.txt") do
	...
	mousePressed=function(e) 
		if e:getClickCount()==2 then 
			if tree1:getLastSelectedPathComponent() and tostring(tree1:getLastSelectedPathComponent()):match("^/") then
				os.execute('pcmanfm ' .. tostring(tree1:getLastSelectedPathComponent()))
				textArea1:setText('pcmanfm ' .. tostring(tree1:getLastSelectedPathComponent()))
