...
This script builds a tree with the input file Tree_Luajava_output_Tree.lua, which is also the output file for saving of a changed tree. Therefore it is called output_Tree. This script is for Linux, Unix or Mac.
