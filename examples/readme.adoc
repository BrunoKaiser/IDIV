...
This script contains the IDIV-Bilanzanalysewerkzeug (IDIV-outil d'analyse du bilan). This script is only for analyses. WARNING: with complex programming instable results can be generated. NO WARRANTY for right results is given.
